<?php 
    $theme->title = sprintf(_('Histórico de Entradas e Saídas | %s'), $appData['app_name']);
    $this->layout("themes/architect-ui/_theme", ['theme' => $theme]);
    
    $this->insert('themes/architect-ui/_components/title', [
        'title' => _('Histórico de Entrada e Saídas'),
        'subtitle' => _('Veja abaixo o histórico de operação de entradas e saídas. Você pode gerar o PDF das etiquetas de entrada ou de saída.'),
        'icon' => 'pe-7s-date',
